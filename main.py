...
cyberIncidents = st.Page("app_model/logic/Cyber_Incidents.py", visibility="hidden")
...
Metadata = st.Page("app_model/logic/Metadata.py", title="Metadata Page", visibility="hidden")
itTickets = st.Page("app_model/logic/IT_Tickets.py", title="IT Tickets", visibility="hidden")
